...
if uploaded_file is not None:
    ...
    if "last_simulation" in st.session_state:
        ...
        m_col3.metric("🚀 Velocidad Media", f"{result['average_speed_kmh']:.2f} km/h")
        m_col4.metric("⚡ Potencia Media", f"{avg_power:.0f} W")
        m_col5.metric("🔋 Energía Total", f"{total_kj:.0f} kJ")
        m_col6.metric("📈 Desnivel", f"{summary['elevation_gain_m']:.1f} m")
        ...
        # ==========================================================
        # PARTE INFERIOR: GRÁFICAS DE RENDIMIENTO INDEPENDIENTES (3 GRÁFICAS)
        # ==========================================================
        st.divider()
        ...
        # --- GRÁFICA 2: Fatiga y Energía (FTP y kJ) ---
        ...
        # --- GRÁFICA 3: Capacidad Anaeróbica (W' en su propio gráfico exclusivo) ---
